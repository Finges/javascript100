...
* 11/4 - Week 5 - Add Ship Object - Chris Lee
*/
...
function ship(){
  ...
  this.length = "3",
  this.isSunk = false,
  this.shipPositions = [location1, location2, location3]
}
...
alert(shipOne.shipPositions)
// This code was edited by Cliff Knopik 10-13-16
while (shipOne.isSunk === false) { // added tripple === here.
  ...
  if (guess < 0 || guess > 6) { // modyfied here Guess to guess.
    ...
    guesses = guesses + 1;
    if (shipOne.shipPositions.indexOf(guess)) {
      alert("HIT!");
      hits = hits + 1;
      if (hits == 3) {
        shipOne.isSunk = true;
